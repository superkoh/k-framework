package me.superkoh.kframework.lib.payment.alipay.sdk.util;

import me.superkoh.kframework.lib.payment.alipay.sdk.config.AlipayConfig;
import me.superkoh.kframework.lib.payment.alipay.sdk.sign.RSA;
...
public class AlipayNotify {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, AlipayConfig config) {
        ...
        if(config.getSignType().equals("RSA")){
        	isSign = RSA.verify(preSignStr, sign, config.getPublicKey(), AlipayConfig.inputCharset);
        }
        return isSign;
    }
