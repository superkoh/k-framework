package me.superkoh.kframework.lib.payment.wechat.sdk.common.report.protocol;

import me.superkoh.kframework.lib.payment.wechat.sdk.common.RandomStringGenerator;
...
public class ReportReqData {
     ...
     */
    public ReportReqData(WXPerAppConfig appConfig, String deviceInfo, String interfaceUrl, int executeTimeCost, String returnCode, String returnMsg, String resultCode, String errCode, String errCodeDes, String outTradeNo, String userIp){
        //微信分配的公众号ID（开通公众号之后可以获取到）
        setAppid(appConfig.getAppID());

        //商户系统自己生成的唯一的订单号
        setOut_trade_no(outTradeNo);

        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        setMch_id(appConfig.getMchID());
        setSub_mch_id(appConfig.getSubMchID());
        ...
        //根据API给的签名规则进行签名
        String sign = Signature.getSign(toMap(), appConfig.getKey());
